...
@section('content')
    ...
    {{-- update modal --}}
    <button class="bg-orange-500 hidden text-white px-4 py-2 rounded-lg hover:bg-orange-700" aria-haspopup="dialog"
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            return `
                                <iframe class="w-full h-48 border rounded" srcdoc="${data.replace(/"/g, '&quot;')}"></iframe>
                            `;
                        }
                    },
                    {
